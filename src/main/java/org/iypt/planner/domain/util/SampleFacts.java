...
public class SampleFacts {
    ...
    // jurors
    public static final Juror jA1 = new Juror(null, "1", CountryCode.AT, INDEPENDENT, true);
    ...
    public static final Juror jB1 = new Juror(null, "1", CountryCode.BE, INDEPENDENT, true);
    ...
    public static final Juror jC1 = new Juror(null, "1", CountryCode.CZ, INDEPENDENT, true);
    ...
    public static final Juror jD1 = new Juror(null, "1", CountryCode.DE, INDEPENDENT, true);
    public static final Juror jD2 = new Juror(null, "2", CountryCode.DE, INDEPENDENT);
    public static final Juror jE1 = new Juror(null, "1", CountryCode.ES, INDEPENDENT, true);
    public static final Juror jE2 = new Juror(null, "2", CountryCode.ES, INDEPENDENT);
    public static final Juror jF1 = new Juror(null, "1", CountryCode.FR, INDEPENDENT, true);
    ...
    public static final Juror jM1 = new Juror(null, "1", CountryCode.MM, INDEPENDENT, true);
    ...
    public static final Juror jN1 = new Juror(null, "1", CountryCode.NL, INDEPENDENT, true);
