...
public class SampleFacts {
    ...
    // jurors
    public static final Juror jA1 = new Juror(null, "1", CountryCode.AT, INDEPENDENT);
    ...
    public static final Juror jB1 = new Juror(null, "1", CountryCode.BE, INDEPENDENT);
    ...
    public static final Juror jC1 = new Juror(null, "1", CountryCode.CZ, INDEPENDENT);
    ...
    public static final Juror jJ1 = new Juror(null, "1", CountryCode.JP, INDEPENDENT);
    public static final Juror jK1 = new Juror(null, "1", CountryCode.KR, INDEPENDENT);
    public static final Juror jL1 = new Juror(null, "1", CountryCode.LV, INDEPENDENT);
    public static final Juror jM1 = new Juror(null, "1", CountryCode.MM, INDEPENDENT);
    ...
    public static final Juror jN1 = new Juror(null, "1", CountryCode.NL, INDEPENDENT);
    ...
    public static final Juror jY1 = new Juror(null, "1", CountryCode.YE, INDEPENDENT);
    public static final Juror jZ1 = new Juror(null, "1", CountryCode.ZA, INDEPENDENT);
