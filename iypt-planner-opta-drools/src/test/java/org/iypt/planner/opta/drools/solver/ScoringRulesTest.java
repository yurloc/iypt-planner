...
import org.iypt.planner.opta.drools.domain.Lock;
...
import static org.iypt.planner.api.constraints.Constants.*;
import static org.iypt.planner.opta.drools.domain.SampleFacts.*;
import static org.iypt.planner.opta.drools.solver.ScoringRulesTest.RuleType.*;
...
public class ScoringRulesTest {
    ...
    private static final String SCORE_DRL = "org/iypt/planner/opta/drools/solver/score_rules.drl";
    ...
    public static void setUpClass() {
        ...
        // do some checks
        KiePackage pkg = kieContainer.getKieBase().getKiePackage("org.iypt.planner.opta.drools.solver");
